...
coronaApp.controller("MainController", function($scope, $http, $filter) {
   ...
   $scope.toggleSearchReportExpand = true;
   
   $scope.toggleSearchReport = function() {

		if ($scope.toggleSearchReportExpand == true) {
			$scope.toggleSearchReportExpand = false;
		}
  ...
  // $scope.sysDate = $filter('date')(new Date(), 'dd-MMM-yyyy');
	...
	$scope.dateChange=function(dateSelected)
	{
		...
		$scope.isDateShow=false;
		$http({
			url :  $scope.contextPath + "/" +  "app_alerts/for-interval/table-data.json?for-date=" + $scope.lastModifiedDate,
			method : "GET",
			headers : {
	 ...
	 $scope.loadQuoteErrorReport = function(event)
	  {
		 ...
		 $scope.loadNewTable (  $scope.contextPath + "/" +  "quote-error-update/table-data.json", "quoteErrorReportTableDiv", "QuoteErrorReportTable", "quoteErrorReportProgress");
  ...
  $("#quoteErrorReportTableDiv").hide();
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "quote-deal-reports/table-data.json", "loadQuoteDealUpdateReportTableDiv", "QuoteDealUpdateReportTable", "loadQuoteDealUpdateReportProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "deal-denied-reports/table-data.json", "loadDealDeniedIssueReportTableDiv", "DealDeniedIssueReportTable", "loadDealDeniedIssueReportProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "backlog-reports/table-data.json", "loadBacklogReportTableDiv", "BacklogReportTable", "loadBacklogReportProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "summary-replication-reports/table-data.json?hours=1", "loadSummaryReplicationReportTableDiv", "SummaryReplicationReportTable", "loadSummaryReplicationReportProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "quote-bmi-reports/table-data.json?hours=1", "loadQuoteBmiReportTableDiv", "QuoteBmiReportTable", "loadQuoteBmiReportProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "wcs-error-reports/table-data.json?hours=1", "loadWcsErrorReportTableDiv", "WcsErrorReportTable", "loadWcsErrorReportProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "bmi-error-reports/table-data.json?hours=1", "loadBmiErrorReportTableDiv", "BmiErrorReportTable", "loadBmiErrorReportProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "summary-qids-reports/table-data.json?hours=1", "loadSummaryQidsReportTableDiv", "SummaryQidsReportTable", "loadSummaryQidsReportProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "summary-qids-reports-processed/table-data.json?hours=1", "loadSummaryQidsProcessedReportTableDiv", "SummaryQidsProcessedReportTable", "loadSummaryQidsProcessedReportProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "summary-qids-reports-failed/table-data.json?hours=1", "loadSummaryQidsReportFailedTableDiv", "SummaryQidsReportFailedTable", "loadSummaryQidsReportFailedProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "summary-qids-reports-transaction/table-data.json?hours=1", "loadSummaryQidsReportTransactionTableDiv", "SummaryQidsReportTransactionTable", "loadSummaryQidsReportTransactionProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "summary-qids-reports-errorentries/table-data.json?hours=1", "loadSummaryQidsReportErrorEntriesTableDiv", "SummaryQidsReportErrorEntriesTable", "loadSummaryQidsReportErrorEntriesProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "summary-qids-reports-rta/table-data.json?hours=1", "loadSummaryQidsReportRtaTableDiv", "SummaryQidsReportRtaTable", "loadSummaryQidsReportRtaProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "list-price-completion-status/table-data.json", "loadListPriceCompletionStatusTableDiv", "ListPriceCompletionStatusTable", "loadListPriceCompletionStatusProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "list-price-report-failed/table-data.json", "loadListPriceReportFailedTableDiv", "ListPriceReportFailedTable", "loadListPriceReportFailedProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "summary-report-service/table-data.json?hours=1", "loadSummaryReportServiceTableDiv", "SummaryReportServiceTable", "loadSummaryReportServiceProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "summary-events-report-cto/table-data.json?hours=1", "loadSummaryEventsReportCtoTableDiv", "SummaryEventsReportCtoTable", "loadSummaryEventsReportCtoProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "summary-propagation-report/table-data.json?hours=1", "loadSummaryPropagationReportTableDiv", "SummaryPropagationReportTable", "loadSummaryPropagationReportProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "summary-permutation-report/table-data.json?hours=1", "loadSummaryPermutationReportTableDiv", "SummaryPermutationReportTable", "loadSummaryPermutationReportProgress");
	  ...
	  {
		  $scope.makeActiveSidebar(event);
		  $scope.loadNewTable (  $scope.contextPath + "/" +  "summary-generic-service/table-data.json", "loadSummaryGenericServiceTableDiv", "SummaryGenericServiceTable", "loadSummaryGenericServiceProgress");
